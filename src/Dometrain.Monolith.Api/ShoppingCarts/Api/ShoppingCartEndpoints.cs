...
namespace Dometrain.Monolith.Api.ShoppingCarts.Api;
...
public static class ShoppingCartEndpoints
{
    ...
    public static async Task<IResult> AddCourse(Guid courseId, IShoppingCartService shoppingCartService,
    ...
    public static async Task<IResult> RemoveCourse(Guid courseId, IShoppingCartService shoppingCartService,
        HttpContext httpContext)
    {
        var studentId = httpContext.GetUserId()!;
