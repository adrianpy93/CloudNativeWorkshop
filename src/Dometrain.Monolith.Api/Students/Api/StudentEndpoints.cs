...
using Dometrain.Monolith.Api.Students.Mappers;
using Dometrain.Monolith.Api.Students.Requests;

#endregion

namespace Dometrain.Monolith.Api.Students.Api;
...
public static class StudentEndpoints
{
    ...
    public static async Task<IResult> Register(StudentRegistrationRequest request, IStudentService studentService)
    {
        ...
        return TypedResults.CreatedAtRoute(createdStudent, GetStudentEndpointName,
            new { idOrEmail = createdStudent!.Id });
    }
